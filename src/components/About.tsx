        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="flex items-start gap-4 mb-6 group">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#3b82f6] dark:bg-[#3b82f6] flex items-center justify-center group-hover:scale-125 group-hover:rotate-12 transition-all duration-300 shadow-lg">
              ...
              <p className="text-lg leading-relaxed text-[#000000] dark:text-[#cccccc]">
                I'm a passionate UI/UX Full Stack Developer with a strong foundation in
                computer science and a keen eye for design. Currently working at mlab, I
            ...
            <div className="flex items-start gap-4 mb-6 group">
              ...
              <p className="text-lg leading-relaxed text-[#000000] dark:text-[#cccccc]">
                My journey in technology began with a deep curiosity about how things work,
                which led me to pursue Computer Science at TUT. Over the years, I've developed
                a comprehensive skill set that spans from user interface design to backend
                development, allowing me to create end-to-end solutions.
              </p>
            </div>
            <div className="flex items-start gap-4 group">
              ...
              <p className="text-lg leading-relaxed text-[#000000] dark:text-[#cccccc]">
                ...
                are not only visually appealing but also intuitive and accessible. Every
                project is an opportunity to learn, grow, and make a positive impact.
              </p>
            </div>
          </div>
          <div className="space-y-6">
            <div className="bg-[#ffffff] dark:bg-[#2a2a2a] p-6 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-l-4 border-[#3b82f6] dark:border-[#60a5fa]">
              ...
              <ul className="space-y-3 text-[#000000] dark:text-[#cccccc]">
