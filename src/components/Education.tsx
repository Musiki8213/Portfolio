      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="space-y-8">
          {education.map((edu, index) => (
            <div
              key={index}
              className="bg-[#ffffff] dark:bg-[#2a2a2a] p-8 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group border-l-4 border-transparent hover:border-[#8b5cf6] dark:hover:border-[#a78bfa]"
            >
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-14 h-14 rounded-lg bg-[#8b5cf6] dark:bg-[#a78bfa] flex items-center justify-center group-hover:scale-125 group-hover:rotate-12 transition-all duration-300 shadow-lg">
                ...
                <div className="text-right mt-2 md:mt-0 flex flex-col gap-1">
                  <p className="text-[#000000] dark:text-[#cccccc] font-medium flex items-center justify-end gap-2">
              ...
              <ul className="list-none space-y-3 text-[#000000] dark:text-[#cccccc] mt-6">
                {edu.description.map((item, i) => (
                  <li key={i} className="flex items-start gap-3 group/item">
                    <svg className="w-5 h-5 mt-1 text-[#8b5cf6] dark:text-[#a78bfa] flex-shrink-0 group-hover/item:scale-150 group-hover/item:rotate-12 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
