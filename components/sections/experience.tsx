...
export function ExperienceSection() {
  return (
    <section id="experience" className="relative border-y border-black/6 bg-zinc-50/40 px-6 py-28 md:py-36">
          ...
          <div className="space-y-10">
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div className="rounded-3xl border border-black/8 bg-white p-8 shadow-premium transition-transform duration-500 hover:-translate-y-1 md:p-10">
                  <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                    <div>
                      <p className="text-xs uppercase tracking-[0.22em] text-zinc-500">
                        {exp.period}
                      </p>
                      <h3 className="mt-2 font-display text-2xl font-semibold tracking-tight text-black md:text-3xl">
                        {exp.title}
                      </h3>
